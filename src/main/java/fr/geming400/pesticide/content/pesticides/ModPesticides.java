...
public final class ModPesticides {
    ...
    public static final PesticideType ATRAZINE = of("atrazine", new PesticideType(1.65f, new MobEffectInstance(MobEffects.POISON, 30*20, 2)));
    public static final PesticideType ENDOSULFAN = of("endosulfan", new PesticideType(2.15f, new MobEffectInstance(MobEffects.WITHER, 15*20, 0)));
